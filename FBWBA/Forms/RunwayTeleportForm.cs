...
{
    public partial class RunwayTeleportForm : Form
    {
        ...
        public RunwayTeleportForm(IAirportDataProvider database, ScreenReaderAnnouncer announcer)
        {
        ...
        private void InitializeComponent()
        {
            ...
            runwayListBox = new ListBox
            {
                ...
                AccessibleDescription = "Select a runway from the list and press Enter to teleport"
            };
            ...
            teleportButton = new Button
            {
                ...
                Size = new Size(75, 30),
                Enabled = false,
                AccessibleName = "Teleport to Selected Runway",
                AccessibleDescription = "Teleport aircraft to the selected runway"
            };
            ...
            cancelButton = new Button
            {
                ...
                AccessibleDescription = "Cancel runway teleport"
            };
