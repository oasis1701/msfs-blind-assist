...
namespace FBWBA.Accessibility
{
    ...
    public class TolkWrapper : IDisposable
    {
        ...
        public bool Initialize()
        {
            ...
            {
                // System.Diagnostics.Debug.WriteLine($"[TolkWrapper] Failed to initialize Tolk: {ex.Message}");
                return false;
            }
        }
        ...
        public bool Speak(string text, bool interrupt = false)
        {
            ...
            {
                // System.Diagnostics.Debug.WriteLine($"[TolkWrapper] Failed to speak via Tolk: {ex.Message}");
                return false;
            }
        }
