// Copyright (c) 2025 - Ported from FlyByWire Simulations A32NX EWDMessages
// Original Copyright (c) 2022 FlyByWire Simulations
...
/// <summary>
/// Lookup dictionary for ECAM (Engine/Warning/Caution/Advisory/Memo) messages.
/// Maps numeric codes from L:A32NX_Ewd_LOWER_LEFT_LINE_* to formatted text.
/// Includes ANSI color code stripping for accessibility.
/// </summary>
public static class EWDMessageLookup
{
    /// <summary>
    /// Maps 9-digit numeric codes to ECAM message text with ANSI formatting
    /// </summary>
    private static readonly Dictionary<string, string> Messages = new Dictionary<string, string>
    {
        // Complete ECAM message dictionary imported from FlyByWire A32NX EWDMessages.tsx
        ...
        ["216326001"] = "\x1b<4m\x1b4mCOND\x1bm",
        ...
        ["340021001"] = "\x1b<2m\x1b4mOVER SPEED\x1bm",
        ["340021002"] = "\x1b<2m -VFE...............177",
        ["340022001"] = "\x1b<2m\x1b4mOVER SPEED\x1bm",
        ["340022002"] = "\x1b<2m -VFE...............185",
        ["340023001"] = "\x1b<2m\x1b4mOVER SPEED\x1bm",
        ["340023002"] = "\x1b<2m -VFE...............200",
        ["340023501"] = "\x1b<2m\x1b4mOVER SPEED\x1bm",
        ["340023502"] = "\x1b<2m -VFE...............215",
        ["340024001"] = "\x1b<2m\x1b4mOVER SPEED\x1bm",
        ...
        // ===== 82 codes synced from current FBW A32NX shared/src/EwdMessages.ts (2026-06) =====
        // These were absent from the original port, so the corresponding A32NX failures/warnings
        // (ELEC GEN/IDG/EMER-CONFIG, AUTO FLT FAC 1/2, HYD RAT, L/G up/down-lock, BRAKES A-SKID/
        // PARK/Y-ACCU, NAV ATC STBY, ENG REV SET, LAV+GALLEY FAN) announced as nothing. Group
        // headers are inlined (\x1b<Nm\x1b4mGROUP\x1bm) per the existing table convention.
        ["000031001"] = "\x1b<3mEMER GEN",
        ["216326002"] = "\x1b<4mLAV+GALLEY FAN FAULT",
        ["220019501"] = "\x1b<4m\x1b4mAUTO FLT\x1bm FAC 2 FAULT",
        ["220019502"] = "\x1b<5m -FAC 2......OFF THEN ON",
        ["220019503"] = "\x1b<7m   .IF UNSUCCESSFUL :",
        ["220019504"] = "\x1b<5m -FAC 2..............OFF",
        ["220020001"] = "\x1b<4m\x1b4mAUTO FLT\x1bm FAC 1 FAULT",
        ["220020002"] = "\x1b<5m -FAC 1......OFF THEN ON",
        ["220020003"] = "\x1b<7m   .IF UNSUCCESSFUL :",
        ["220020004"] = "\x1b<5m -FAC 1..............OFF",
        ["220020501"] = "\x1b<4m\x1b4mAUTO FLT\x1bm FAC 1+2 FAULT",
        ["220020502"] = "\x1b<5mRUD WITH CARE ABV 140 KT",
        ["220020503"] = "\x1b<5m -FAC 1......OFF THEN ON",
        ["220020504"] = "\x1b<5m -FAC 2......OFF THEN ON",
        ["220020505"] = "\x1b<7m   .IF UNSUCCESSFUL :",
        ["220020506"] = "\x1b<5m -FAC 1..............OFF",
        ["220020507"] = "\x1b<5m -FAC 2..............OFF",
        ...
        ["240003101"] = "\x1b<2m\x1b4mELEC\x1bm \x1b'mEMER CONFIG\x1bm",
        ["240003102"] = "\x1b<5m MIN RAT SPEED.....140KT",
        ["240003103"] = "\x1b<5m -GEN 1+2....OFF THEN ON",
        ["240003104"] = "\x1b<7m   .IF UNSUCCESSFUL :",
        ["240003105"] = "\x1b<5m -BUS TIE............OFF",
        ["240003106"] = "\x1b<5m -GEN 1+2....OFF THEN ON",
        ["240003107"] = "\x1b<5m -EMER ELEC PWR...MAN ON",
        ["240003108"] = "\x1b<5m -ENG MODE SEL.......IGN",
        ["240003109"] = "\x1b<5m -VHF1/ATC1..........USE",
        ["240003110"] = "\x1b<5m FUEL GRVTY FEED",
        ["240003111"] = "\x1b<5m PROC:GRVTY FUEL FEEDING",
        ["240003112"] = "\x1b<5m -FAC 1......OFF THEN ON",
        ["240003113"] = "\x1b<5m -BUS TIE...........AUTO",
        ["240003114"] = "\x1b<5m -APU (IF AVAIL)...START",
        ["240003115"] = "\x1b<5m -BLOWER + EXTRACT..OVRD",
        ["240003116"] = "\x1b<5m FUEL CONSUMPT INCRSD",
        ["240003117"] = "\x1b<5m FMS PRED UNRELIABLE",
        ...
        ["240062001"] = "\x1b<4m\x1b4mELEC\x1bm EMER GEN 1 LINE OFF",
        ...
        ["290014301"] = "\x1b<4m\x1b4mHYD\x1bm RAT FAULT",
        ...
        ["320013001"] = "\x1b<4m\x1b4mL/G\x1bm GEAR NOT UPLOCKED",
        ["320013002"] = "\x1b<5m MAX SPEED.......220/.54",
        ["320013003"] = "\x1b<5m -L/G............RECYCLE",
        ["320013004"] = "\x1b<7m    .IF UNSUCCESSFUL",
        ["320013005"] = "\x1b<5m -L/G...............DOWN",
        ["320013006"] = "\x1b<5m MAX SPEED.......280/.67",
        ["320013007"] = "\x1b<5m AVOID EXCESS G FACTOR",
        ["320013008"] = "\x1b<5m FUEL CONSUMPT INCRSD",
        ["320013009"] = "\x1b<5m FMS PRED UNRELIABLE",
    ...
    /// <summary>
    /// Looks up an ECAM message by its numeric code and returns cleaned text
    /// </summary>
    ...
    public static string GetMessage(long code)
    {
        ...
        {
            return CleanANSICodes(rawMessage);
        }
