...
// FCU buttons
    ...
    // protected so an FBW fork subclass (HeadwindA330Definition) can reuse the deferred read-out.
    protected static void DeferReadback(Action readback, int delayMs = 300)
    {
