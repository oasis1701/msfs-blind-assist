...
/// <summary>
/// Landing-light and altimeter-standard management for the FlyByWire A320 based on
/// altitude crossings — the Fenix monitor's structure with FBW A320 actions.
///
...
/// </summary>
public sealed class HwA330FlightPhaseMonitor : IFoPhaseMonitor
{
    private readonly HwA330ActionExecutor _executor;
    ...
    public HwA330FlightPhaseMonitor(HwA330ActionExecutor executor, ScreenReaderAnnouncer announcer)
    {
        _executor = executor;
