...
/// <summary>
/// Automated gear, autopilot and flap management for the FlyByWire A320.
...
/// </summary>
public sealed class HwA330FOAutoManager : IFoAutoManager
{
    private readonly HwA330ActionExecutor _executor;
    private readonly HwA330StateEvaluator _state;
    ...
    public HwA330FOAutoManager(
        HwA330ActionExecutor executor,
        HwA330StateEvaluator state,
