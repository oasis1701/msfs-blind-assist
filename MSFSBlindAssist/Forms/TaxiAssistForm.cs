...
/// - Destination type selection (Runway / Holding Point / Gate-Parking / Cross Runway)
/// - Destination combo (runways, holding points, gates, or runway crossings sorted by distance)
...
public class TaxiAssistForm : Form
{
    ...
    private void InitializeFormControls()
    {
        ...
        cmbDestType = new ComboBox
        {
            ...
            AccessibleDescription = "Select whether to taxi to a runway, holding point, gate/parking position, or to cross a runway"
        };
        cmbDestType.Items.AddRange(new object[] { "Runway", "Holding Point", "Gate / Parking", "Cross Runway" });
    ...
    private void PopulateDestinations()
    {
        ...
        bool isParking = cmbDestType.SelectedIndex == 2;
        bool isCrossRunway = cmbDestType.SelectedIndex == 3;
    ...
    private void OnCalculateClicked(object? sender, EventArgs e)
    {
        ...
        if (cmbDestType.SelectedIndex == 3)
        {
