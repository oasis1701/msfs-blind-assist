...
public class FBWA320VSWindow : FBWA320FCUWindowBase
{
        ...
        : base(aircraft, simConnect, announcer)
    {
        ...
        pullButton.Click += (s, e) => aircraft.FireFCUButton("A32NX.FCU_VS_PULL", simConnect, announcer);
    ...
    protected override void SpeakInitialReadout() { aircraft.RequestFCUVSReadout(simConnect); vsTextBox.Focus(); }
