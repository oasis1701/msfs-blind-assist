...
public partial class PMDG737CDUForm : Form
{
    ...
    private readonly IPMDGDataManager _dataManager;
    private readonly ScreenReaderAnnouncer _announcer;
    private readonly System.Windows.Forms.Timer _pollTimer;
    private string[]? _previousRows;
    private string _previousScratchpad = "";
    private int _selectedCDU = 0;
    // NG3: dropdown index maps directly to PMDG SDK CDU data area index
    // (0 = Captain / Left, 1 = First Officer / Right). No swap needed.
    private int DataCDUIndex => _selectedCDU;
    ...
    private void SetupEventHandlers()
    {
        ...
        btnClb.Click      += (s, e) => SendCDUKey("CLB");
        btnCrz.Click      += (s, e) => SendCDUKey("CRZ");
        btnDes.Click      += (s, e) => SendCDUKey("DES");
        ...
        btnN1Limit.Click  += (s, e) => SendCDUKey("N1_LIMIT");
    ...
    {
        // NG3 ships both EVT_CDU_L_* and EVT_CDU_R_* event sets — no fallback needed.
    ...
    private void Form_KeyDown(object? sender, KeyEventArgs e)
    {
        ...
        // Alt+letter: 737 page button hotkeys
