...
- A stop the aircraft has already rolled more than 10 m past (`HoldPointIsBehindAircraft`) is recorded as not held and not placed: a recalculated route is built from the live position, and "Stop. Hold short of runway 26R" to an aircraft already cleared onto 26R is a stop in the worst possible place.
