(function(){try{
  ...
  var node=conts[10]; // TROPO (editable, default 36090)
  if(!node)return "no field 10";
  ...
  dispatchKey(span,"keypress",13);
  return JSON.stringify({before:before,midway:midway,afterEnter:span.textContent});
